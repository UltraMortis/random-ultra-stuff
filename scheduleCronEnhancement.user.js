...
// @match        https://panel.ultraservers.com/server/*/schedules
...
(function () {
  ...
  document.addEventListener('click', async (e) => {
    ...
    for (let i = 0; i < 50; i++) {
      modal = document.querySelector('#headlessui-dialog-panel-4');
      if (modal) break;
    ...
    document.getElementById('ai-cron-generate-btn').addEventListener('click', () => {
      ...
      GM_xmlhttpRequest({
        ...
        onload(res) {
          ...
          // A function to set the values of the cron UI elements. You may wonder why I didn't use `el.value = val` directly. It's becuase the UI would reset so this hack was used
