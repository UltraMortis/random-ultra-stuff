...
// @match        https://panel.ultraservers.com/server/*/backups
...
(async function () {
  ...
  // Get backup list of your current server. Only works if you have permissions
  const backupRes = await fetch(`${panelOrigin}/api/client/servers/${serverId}/backups`, {
    method: 'GET',
    headers
  });
